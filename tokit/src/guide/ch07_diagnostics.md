...
grammar — it is a property of *what you do with a diagnostic once you have one*. So tokit puts
...
the view a renderer wants; tokit ships the data and takes on no dependency on ariadne, miette,
or anything else.
