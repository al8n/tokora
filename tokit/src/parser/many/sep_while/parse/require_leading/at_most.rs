...
impl<'inp, L, F, Sep, Condition, O, Container, Ctx, Lang: ?Sized, W>
  ...
  for Collect<
    RequireLeading<AtMost<SeparatedWhile<F, Sep, Condition, O, W, L, Ctx, Lang>>>,
    Container,
    Ctx,
    Lang,
  >
...
impl<'inp, 'c, L, F, Sep, Condition, O, Container, Ctx, Lang: ?Sized, W>
  ...
  for Collect<
    &'c mut RequireLeading<AtMost<SeparatedWhile<&'c mut F, Sep, Condition, O, W, L, Ctx, Lang>>>,
    &'c mut Container,
    Ctx,
    Lang,
  >
...
impl<'inp, 'c, L, F, Sep, Condition, O, Container, Ctx, Lang: ?Sized, W>
  ...
  for Wrapper<
    Collect<
      RequireLeading<AtMost<SeparatedWhile<&'c mut F, Sep, &'c mut Condition, O, W, L, Ctx, Lang>>>,
      &'c mut Container,
      Ctx,
      Lang,
    >,
