...
impl<'inp, L, F, Sep, Condition, O, Container, Ctx, Lang: ?Sized, W>
  ...
  for Collect<
    RequireLeading<RequireTrailing<Bounded<SeparatedWhile<F, Sep, Condition, O, W, L, Ctx, Lang>>>>,
    Container,
    Ctx,
    Lang,
  >
...
impl<'inp, L, F, Sep, Condition, O, Container, Ctx, Lang: ?Sized, W>
  ...
  for With<
    Collect<
      RequireLeading<
        RequireTrailing<Bounded<SeparatedWhile<F, Sep, Condition, O, W, L, Ctx, Lang>>>,
      >,
      Container,
      Ctx,
      Lang,
...
impl<'inp, 'c, L, F, Sep, Condition, O, Container, Ctx, Lang: ?Sized, W>
  ...
  for Collect<
    &'c mut RequireLeading<
      RequireTrailing<Bounded<SeparatedWhile<&'c mut F, Sep, Condition, O, W, L, Ctx, Lang>>>,
    >,
    &'c mut Container,
    Ctx,
    Lang,
  ...
  W: Window,
{
  ...
  fn parse_input(
    ...
    let limitation = RequireLeading::new(RequireTrailing::new(parser.parser.parser.to_with()));
