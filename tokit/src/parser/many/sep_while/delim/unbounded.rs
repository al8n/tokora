...
impl<'inp, L, F, Sep, Condition, O, Delim, Container, Ctx, Lang: ?Sized, W>
  ...
  for Collect<
    DelimitedBy<SeparatedWhile<F, Sep, Condition, O, W, L, Ctx, Lang>, Delim>,
    Container,
    Ctx,
    Lang,
  >
...
impl<'inp, 'c, L, F, Sep, Condition, O, Delim, Container, Ctx, Lang: ?Sized, W>
  ...
  for Collect<
    &'c mut DelimitedBy<SeparatedWhile<&'c mut F, Sep, Condition, O, W, L, Ctx, Lang>, Delim>,
    &'c mut Container,
    Ctx,
    Lang,
  >
...
impl<'inp, 'c, L, F, Sep, Condition, O, Delim, Container, Ctx, Lang: ?Sized, W>
  ...
  for Wrapper<
    Collect<
      DelimitedBy<SeparatedWhile<&'c mut F, Sep, &'c mut Condition, O, W, L, Ctx, Lang>, Delim>,
      &'c mut Container,
      Ctx,
      Lang,
    >,
