...
impl<'inp, L, F, Sep, Condition, O, Delim, Container, Ctx, Lang: ?Sized, W>
  ...
  for Collect<
    DelimitedBy<
      AllowLeading<AllowTrailing<AtMost<SeparatedWhile<F, Sep, Condition, O, W, L, Ctx, Lang>>>>,
      Delim,
    >,
    Container,
    Ctx,
...
impl<'inp, 'c, L, F, Sep, Condition, O, Delim, Container, Ctx, Lang: ?Sized, W>
  ...
  for Collect<
    &'c mut DelimitedBy<
      AllowLeading<
        AllowTrailing<AtMost<SeparatedWhile<&'c mut F, Sep, Condition, O, W, L, Ctx, Lang>>>,
      >,
      Delim,
    >,
    &'c mut Container,
  ...
  Delim: Delimiter<'inp, L, Lang>,
{
    ...
    Ctx: ParseContext<'inp, L, Lang>,
  {
    ...
    let parser = DelimitedBy::<_, Delim>::new(AllowLeading::new(AllowTrailing::new(AtMost::new(
  ...
  for Wrapper<
    Collect<
      DelimitedBy<
        AllowLeading<
          AllowTrailing<
            AtMost<SeparatedWhile<&'c mut F, Sep, &'c mut Condition, O, W, L, Ctx, Lang>>,
          >,
        >,
        Delim,
      >,
  ...
  Delim: Delimiter<'inp, L, Lang>,
{
  ...
  fn parse_input(
    ...
    let maximum = AllowLeading::new(AllowTrailing::new(parser.parser.parser.parser.maximum()));
