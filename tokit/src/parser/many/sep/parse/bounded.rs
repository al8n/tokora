...
impl<'inp, L, F, Sep, O, Container, Ctx, Lang: ?Sized> ParseInput<'inp, L, Container, Ctx, Lang>
  for Collect<Bounded<Separated<F, Sep, O, L, Ctx, Lang>>, Container, Ctx, Lang>
where
  L: Lexer<'inp>,
...
impl<'inp, L, F, Sep, O, Container, Ctx, Lang: ?Sized>
  ...
  for With<Collect<Bounded<Separated<F, Sep, O, L, Ctx, Lang>>, Container, Ctx, Lang>, PhantomSpan>
where
  L: Lexer<'inp>,
  F: TryParseInput<'inp, L, O, Ctx, Lang>,
  Sep: Punctuator<'inp, L, Lang>,
...
impl<'inp, 'c, L, F, Sep, O, Container, Ctx, Lang: ?Sized> ParseInput<'inp, L, L::Span, Ctx, Lang>
  for Collect<
    &'c mut Bounded<Separated<&'c mut F, Sep, O, L, Ctx, Lang>>,
    &'c mut Container,
    Ctx,
    Lang,
  >
...
impl<'inp, 'c, L, F, Sep, O, Container, Ctx, Lang: ?Sized> ParseInput<'inp, L, L::Span, Ctx, Lang>
  for Wrapper<
    Collect<Bounded<Separated<&'c mut F, Sep, O, L, Ctx, Lang>>, &'c mut Container, Ctx, Lang>,
  >
where
  L: Lexer<'inp>,
  F: TryParseInput<'inp, L, O, Ctx, Lang>,
