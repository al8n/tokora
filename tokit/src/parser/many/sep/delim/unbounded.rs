...
impl<'inp, L, F, Sep, O, Delim, Container, Ctx, Lang: ?Sized>
  ...
  for Collect<DelimitedBy<Separated<F, Sep, O, L, Ctx, Lang>, Delim>, Container, Ctx, Lang>
where
  L: Lexer<'inp>,
...
impl<'inp, L, F, Sep, O, Delim, Container, Ctx, Lang: ?Sized>
  ...
  for With<
    Collect<DelimitedBy<Separated<F, Sep, O, L, Ctx, Lang>, Delim>, Container, Ctx, Lang>,
    PhantomSpan,
  >
where
  L: Lexer<'inp>,
...
impl<'inp, 'c, L, F, Sep, O, Delim, Container, Ctx, Lang: ?Sized>
  ...
  for Collect<
    &'c mut DelimitedBy<Separated<&'c mut F, Sep, O, L, Ctx, Lang>, Delim>,
    &'c mut Container,
    Ctx,
    Lang,
  >
...
impl<'inp, 'c, L, F, Sep, O, Delim, Container, Ctx, Lang: ?Sized>
  ...
  for Wrapper<
    Collect<
      DelimitedBy<Separated<&'c mut F, Sep, O, L, Ctx, Lang>, Delim>,
      &'c mut Container,
      Ctx,
      Lang,
    >,
