...
impl<'inp, L, F, Sep, O, Delim, Container, Ctx, Lang: ?Sized>
  ...
  for Collect<
    DelimitedBy<RequireTrailing<Separated<F, Sep, O, L, Ctx, Lang>>, Delim>,
    Container,
    Ctx,
    Lang,
  >
...
impl<'inp, 'c, L, F, Sep, O, Delim, Container, Ctx, Lang: ?Sized>
  ...
  for Collect<
    &'c mut DelimitedBy<RequireTrailing<Separated<&'c mut F, Sep, O, L, Ctx, Lang>>, Delim>,
    &'c mut Container,
    Ctx,
    Lang,
  >
  ...
  Delim: Delimiter<'inp, L, Lang>,
{
    ...
    Ctx: ParseContext<'inp, L, Lang>,
  {
    ...
    let parser =
      DelimitedBy::<_, Delim>::new_in(RequireTrailing::new(Separated::new::<Sep>(&mut **f)));
...
impl<'inp, 'c, L, F, Sep, O, Delim, Container, Ctx, Lang: ?Sized>
  ...
  for Wrapper<
    Collect<
      DelimitedBy<RequireTrailing<Separated<&'c mut F, Sep, O, L, Ctx, Lang>>, Delim>,
      &'c mut Container,
      Ctx,
      Lang,
    >,
