...
impl<'inp, L, F, Sep, O, Delim, Container, Ctx, Lang: ?Sized>
  ...
  for Collect<
    DelimitedBy<RequireLeading<AllowTrailing<Bounded<Separated<F, Sep, O, L, Ctx, Lang>>>>, Delim>,
    Container,
    Ctx,
    Lang,
  >
...
impl<'inp, L, F, Sep, O, Delim, Container, Ctx, Lang: ?Sized>
  ...
  for With<
    Collect<
      DelimitedBy<
        RequireLeading<AllowTrailing<Bounded<Separated<F, Sep, O, L, Ctx, Lang>>>>,
        Delim,
      >,
      Container,
      Ctx,
...
impl<'inp, 'c, L, F, Sep, O, Delim, Container, Ctx, Lang: ?Sized>
  ...
  for Collect<
    &'c mut DelimitedBy<
      RequireLeading<AllowTrailing<Bounded<Separated<&'c mut F, Sep, O, L, Ctx, Lang>>>>,
      Delim,
    >,
    &'c mut Container,
    Ctx,
