...
mod cst_coverage {
  ...
  // Note: rowan::Language already provides a blanket impl for tokit::syntax::Language,
  ...
  impl CstNode<Lang> for InnerNode {
    ...
    ) -> Result<Self, tokit::cst::error::SyntaxError<Self, Lang>> {
...
mod utils_misc_coverage {
  use tokit::utils::{CharLen, IsAsciiChar, PositionedChar};
...
fn parser_of_construction() {
  // Covers Parser::of()
  let p: tokit::Parser<(), TestLexer<'_>, i64, _, ()> =
