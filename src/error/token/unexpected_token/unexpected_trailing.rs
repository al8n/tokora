  ...
  (
    ...
    paste::paste! {
      $(
        ...
        impl<T, Kind: Clone, S> UnexpectedToken<'_, T, Kind, S, Trailing<$name>> {
        ...
        impl<T, Kind: Clone, S, Lang> UnexpectedToken<'_, T, Kind, S, Trailing<$name, Lang>> {
        ...
        impl<T, Kind: Clone, S, Lang> ::core::fmt::Debug for UnexpectedToken<'_, T, Kind, S, Trailing<$name, Lang>>
        where
          S: ::core::fmt::Debug,
          T: ::core::fmt::Debug,
          Lang: ?Sized,
        ...
        impl<T, Kind: Clone, S, Lang> ::core::fmt::Display for UnexpectedToken<'_, T, Kind, S, Trailing<$name, Lang>>
        where
          S: ::core::fmt::Display,
          Lang: ?Sized,
        {
        ...
        impl<T, Kind: Clone, S, Lang> ::core::error::Error for UnexpectedToken<'_, T, Kind, S, Trailing<$name, Lang>>
        where
