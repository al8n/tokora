  ...
  (
    ...
    paste::paste! {
      $(
        ...
        impl<Kind: Clone, O> MissingToken<'_, Kind, O, Trailing<$name>> {
        ...
        impl<Kind: Clone, O, Lang: ?Sized> MissingToken<'_, Kind, O, Trailing<$name, Lang>> {
          #[doc = "Create a new `MissingToken` error indicating a trailing `" $name "` was missing for a specific language."]
          #[cfg_attr(not(tarpaulin), inline(always))]
        ...
        impl<Kind: Clone, O, Lang: ?Sized> ::core::fmt::Debug for MissingToken<'_, Kind, O, Trailing<$name, Lang>>
        where
          O: ::core::fmt::Debug,
        {
          #[cfg_attr(not(tarpaulin), inline(always))]
        ...
        impl<Kind: Clone, O, Lang: ?Sized> ::core::fmt::Display for MissingToken<'_, Kind, O, Trailing<$name, Lang>>
        where
          O: ::core::fmt::Display,
        {
          #[cfg_attr(not(tarpaulin), inline(always))]
        ...
        impl<Kind: Clone, O, Lang: ?Sized> ::core::error::Error for MissingToken<'_, Kind, O, Trailing<$name, Lang>>
        where
