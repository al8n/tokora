use crate::{emitter::UnexpectedTrailingSeparatorEmitter, error::token::UnexpectedTrailingOf};
...
impl<'inp, L, F, SepClassifier, O, Container, Ctx, Lang: ?Sized>
  ...
  for Collect<AllowLeading<Separated<F, SepClassifier, O, L, Ctx, Lang>>, Container, Ctx, Lang>
where
  L: Lexer<'inp>,
...
impl<'inp, L, F, SepClassifier, O, Container, Ctx, Lang: ?Sized>
  ...
  for With<
    Collect<AllowLeading<Separated<F, SepClassifier, O, L, Ctx, Lang>>, Container, Ctx, Lang>,
    PhantomSpan,
  >
where
  L: Lexer<'inp>,
...
impl<'inp, 'c, L, F, SepClassifier, O, Container, Ctx, Lang: ?Sized>
  ...
  for Collect<
    &'c mut AllowLeading<Separated<F, SepClassifier, O, L, Ctx, Lang>>,
    &'c mut Container,
    Ctx,
    Lang,
  >
  ...
  Container: ContainerT<O> + SeparatorHandler<'inp, L>,
{
    ...
    Ctx: ParseContext<'inp, L, Lang>,
  {
    ...
    let parser = AllowLeading::new(Separated {
      f: &mut *f,
      sep: &mut *sep,
      _m: PhantomData,
      _ctx: PhantomData,
...
impl<'inp, 'c, L, F, SepClassifier, O, Container, Ctx, Lang: ?Sized>
  ...
  for Wrapper<
    Collect<
      AllowLeading<Separated<&'c mut F, &'c mut SepClassifier, O, L, Ctx, Lang>>,
      &'c mut Container,
      Ctx,
      Lang,
    >,
