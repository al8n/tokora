use crate::{
  emitter::{TooFewEmitter, TooManyEmitter, UnexpectedTrailingSeparatorEmitter},
...
impl<'inp, 'closure, Sep, O, L, Ctx, Lang: ?Sized>
  EndStateHandler<'inp, 'closure, Sep, O, L, Ctx, Lang> for AllowLeading<With<Minimum, Maximum>>
where
  L: Lexer<'inp>,
