use crate::{
  emitter::{MissingLeadingSeparatorEmitter, MissingTrailingSeparatorEmitter},
...
impl<'inp, L, F, SepClassifier, Condition, O, Container, Ctx, Lang: ?Sized, W>
  ...
  for Collect<
    RequireLeading<RequireTrailing<Separated<F, SepClassifier, Condition, O, W, L, Ctx, Lang>>>,
    Container,
    Ctx,
    Lang,
  >
...
impl<'inp, 'c, L, F, SepClassifier, Condition, O, Container, Ctx, Lang: ?Sized, W>
  ...
  for Collect<
    &'c mut RequireLeading<
      RequireTrailing<Separated<F, SepClassifier, Condition, O, W, L, Ctx, Lang>>,
    >,
    &'c mut Container,
    Ctx,
    Lang,
