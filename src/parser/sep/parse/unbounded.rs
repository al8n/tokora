...
impl<'inp, L, F, SepClassifier, Condition, O, Container, Ctx, Lang: ?Sized, W>
  ...
  for Collect<Separated<F, SepClassifier, Condition, O, W, L, Ctx, Lang>, Container, Ctx, Lang>
where
  L: Lexer<'inp>,
...
impl<'inp, L, F, SepClassifier, Condition, O, Container, Ctx, Lang: ?Sized, W>
  ...
  for With<
    Collect<Separated<F, SepClassifier, Condition, O, W, L, Ctx, Lang>, Container, Ctx, Lang>,
    PhantomSpan,
  >
where
  L: Lexer<'inp>,
...
impl<'inp, 'c, L, F, SepClassifier, Condition, O, Container, Ctx, Lang: ?Sized, W>
  ...
  for Collect<
    &'c mut Separated<&'c mut F, &'c mut SepClassifier, Condition, O, W, L, Ctx, Lang>,
    &'c mut Container,
    Ctx,
    Lang,
  >
