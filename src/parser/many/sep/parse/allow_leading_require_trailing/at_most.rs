...
impl<'inp, L, F, SepClassifier, O, Container, Ctx, Lang: ?Sized>
  ...
  for Collect<
    AllowLeading<RequireTrailing<AtMost<Separated<F, SepClassifier, O, L, Ctx, Lang>>>>,
    Container,
    Ctx,
    Lang,
  >
...
impl<'inp, 'c, L, F, SepClassifier, O, Container, Ctx, Lang: ?Sized>
  ...
  for Collect<
    &'c mut AllowLeading<
      RequireTrailing<AtMost<Separated<&'c mut F, SepClassifier, O, L, Ctx, Lang>>>,
    >,
    &'c mut Container,
    Ctx,
    Lang,
...
impl<'inp, 'c, L, F, SepClassifier, O, Container, Ctx, Lang: ?Sized>
  ...
  for Wrapper<
    Collect<
      AllowLeading<RequireTrailing<AtMost<Separated<&'c mut F, SepClassifier, O, L, Ctx, Lang>>>>,
      &'c mut Container,
      Ctx,
      Lang,
    >,
