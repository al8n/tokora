...
impl<'inp, L, F, SepClassifier, O, Container, Ctx, Lang: ?Sized>
  ...
  for Collect<Bounded<Separated<F, SepClassifier, O, L, Ctx, Lang>>, Container, Ctx, Lang>
where
  L: Lexer<'inp>,
...
impl<'inp, L, F, SepClassifier, O, Container, Ctx, Lang: ?Sized>
  ...
  for With<
    Collect<Bounded<Separated<F, SepClassifier, O, L, Ctx, Lang>>, Container, Ctx, Lang>,
    PhantomSpan,
  >
where
  L: Lexer<'inp>,
...
impl<'inp, 'c, L, F, SepClassifier, O, Container, Ctx, Lang: ?Sized>
  ...
  for Collect<
    &'c mut Bounded<Separated<&'c mut F, SepClassifier, O, L, Ctx, Lang>>,
    &'c mut Container,
    Ctx,
    Lang,
  >
...
impl<'inp, 'c, L, F, SepClassifier, O, Container, Ctx, Lang: ?Sized>
  ...
  for Wrapper<
    Collect<
      Bounded<Separated<&'c mut F, SepClassifier, O, L, Ctx, Lang>>,
      &'c mut Container,
      Ctx,
      Lang,
    >,
