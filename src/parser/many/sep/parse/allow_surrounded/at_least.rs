...
impl<'inp, L, F, SepClassifier, O, Container, Ctx, Lang: ?Sized>
  ...
  for Collect<
    AllowLeading<AllowTrailing<AtLeast<Separated<F, SepClassifier, O, L, Ctx, Lang>>>>,
    Container,
    Ctx,
    Lang,
  >
where
  ...
  Ctx::Emitter: SeparatedEmitter<'inp, SepClassifier, L, Lang> + TooFewEmitter<'inp, L, Lang>,
...
impl<'inp, 'c, L, F, SepClassifier, O, Container, Ctx, Lang: ?Sized>
  ...
  for Wrapper<
    Collect<
      AllowLeading<AllowTrailing<AtLeast<Separated<&'c mut F, SepClassifier, O, L, Ctx, Lang>>>>,
      &'c mut Container,
      Ctx,
      Lang,
    >,
