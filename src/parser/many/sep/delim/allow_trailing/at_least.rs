...
impl<'inp, L, F, Sep, O, Delim, Container, Ctx, Lang: ?Sized>
  ...
  for Collect<
    DelimitedBy<AllowTrailing<AtLeast<Separated<F, Sep, O, L, Ctx, Lang>>>, Delim>,
    Container,
    Ctx,
    Lang,
  >
...
impl<'inp, 'c, L, F, Sep, O, Delim, Container, Ctx, Lang: ?Sized>
  ...
  for Collect<
    &'c mut DelimitedBy<AllowTrailing<AtLeast<Separated<&'c mut F, Sep, O, L, Ctx, Lang>>>, Delim>,
    &'c mut Container,
    Ctx,
    Lang,
  >
  ...
  Delim: Delimiter<'inp, L, Lang>,
{
    ...
    Ctx: ParseContext<'inp, L, Lang>,
  {
    ...
    let parser = DelimitedBy::<_, Delim>::new_in(AllowTrailing::new(AtLeast::new(
...
impl<'inp, 'c, L, F, Sep, O, Delim, Container, Ctx, Lang: ?Sized>
  ...
  for Wrapper<
    Collect<
      DelimitedBy<AllowTrailing<AtLeast<Separated<&'c mut F, Sep, O, L, Ctx, Lang>>>, Delim>,
      &'c mut Container,
      Ctx,
      Lang,
    >,
