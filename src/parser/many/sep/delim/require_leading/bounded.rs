...
impl<'inp, L, F, SepClassifier, O, Delim, Container, Ctx, Lang: ?Sized>
  ...
  for Collect<
    DelimitedBy<RequireLeading<Bounded<Separated<F, SepClassifier, O, L, Ctx, Lang>>>, Delim>,
    Container,
    Ctx,
    Lang,
  >
  ...
  Delim: DelimiterSelector<'inp, L, Lang>,
{
    ...
    Ctx: ParseContext<'inp, L, Lang>,
  {
    ...
    let parser = DelimitedBy::new_in(RequireLeading::new(Bounded::new(
  ...
  Delim: DelimiterSelector<'inp, L, Lang>,
{
  ...
  fn parse_input(
    ...
    let limitation = RequireLeading::new(parser.parser.parser.to_with());
