...
impl<'inp, L, F, SepClassifier, Condition, O, Delim, Container, Ctx, Lang: ?Sized, W>
  ...
  for Collect<
    DelimitedBy<
      RequireLeading<
        AllowTrailing<AtMost<SeparatedWhile<F, SepClassifier, Condition, O, W, L, Ctx, Lang>>>,
      >,
      Delim,
    >,
    Container,
...
impl<'inp, 'c, L, F, SepClassifier, Condition, O, Delim, Container, Ctx, Lang: ?Sized, W>
  ...
  for Collect<
    &'c mut DelimitedBy<
      RequireLeading<
        AllowTrailing<
          AtMost<SeparatedWhile<&'c mut F, &'c mut SepClassifier, Condition, O, W, L, Ctx, Lang>>,
        >,
      >,
      Delim,
    >,
  ...
  Delim: DelimiterSelector<'inp, L, Lang>,
{
    ...
    Ctx: ParseContext<'inp, L, Lang>,
  {
    ...
    let parser = DelimitedBy::new_in(RequireLeading::new(AllowTrailing::new(AtMost::new(
